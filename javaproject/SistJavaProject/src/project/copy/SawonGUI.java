...
public class SawonGUI extends JFrame {
    ...
    public SawonGUI() {
        ...
        String[] columnNames = { "사원번호", "사원이름", "성별", "부서", "급여", "입사일" };
    ...
    private JPanel createButtonPanel() {
        ...
        buttonPanel.add(createButton("회원가입", e -> showInputDialog()));
        buttonPanel.add(createButton("전체회원출력", e -> controller.selectAll()));
    ...
    public void showInputDialog() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            controller.registerMember(nameField.getText(), gender, (String) buseoComboBox.getSelectedItem(), payField.getText());
        }
    }
    ...
    public void showUpdateDialog() {
        ...
        int result = JOptionPane.showConfirmDialog(this, panel, "회원정보 수정", JOptionPane.OK_CANCEL_OPTION);
        if (result == JOptionPane.OK_OPTION) {
            String updatedGender = getSelectedGender();
            controller.updateMember(num,nameField.getText(), updatedGender, (String) buseoComboBox.getSelectedItem(), payField.getText());
        }
    }
    ...
    public void showSearchDialog() {
        ...
        int result = JOptionPane.showConfirmDialog(this, panel, "회원 검색", JOptionPane.OK_CANCEL_OPTION);
        if (result == JOptionPane.OK_OPTION) {
